  ...
  return (
    <main className="flex flex-col justify-center items-center my-[50px] lg:my-0">
      ...
      <div className="inline-flex flex-col items-center gap-6">
          ...
          <p className="text-[16px] text-center lg:text-[24px] text-[#4D5254] flex flex-col lg:flex-row capitalize">Lorem ipsum dolor sit amet, consectetur&nbsp; <span>adipiscing</span> </p>
      </div>
