...
const CardReview = () => {
  return (
    <div className='flex flex-col gap-[18px] bg-white p-6 rounded-[10px]'>
      <div className='flex gap-[13px] justify-center items-center w-fit'>
        <Image src='https://e-jam.vercel.app/rectangle-1127@2x.png' alt='avatar' height={48} width={48} className='rounded-[50%] flex' />
        <div className='flex flex-col'>
          ...
          <div>
            <p className='text-[#333] font-bold text-sm'>Ken T.</p>
            <div className='flex gap-[10px] text-xs text-[#5BB59A]'>
      ...
      <p className='text-[#4D5254] text-base self-stretch'>
